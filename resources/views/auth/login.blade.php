            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo h3 mb-0 fw-bold">Sakola</span>
                </a>
              </div>
              <!-- /Logo -->
...
<head>
    ...
    <link href="{{ asset('template/architectui/main.8d288f825d8dffbbe55e.css')}}') }}" rel="stylesheet">
</head>
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                <div class="position-relative form-group"><input name="email" id="email" placeholder="Email disini..." type="email" class="form-control" name="email" :value="old('email')"></div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="position-relative form-group"><input name="password" id="password" placeholder="Password disini..." name="password" type="password" class="form-control"></div>
                                            </div>
                                        </div>
                                </div>
...
<script type="text/javascript" src="{{ asset('template/architectui/assets/scripts/main.8d288f825d8dffbbe55e.js')}}') }} "></script>
