<x-frest-layout title="Dashboard" menu="dashboard">
    <x-slot name="vendor_css">
        <link rel="stylesheet" href="{{ asset('template/frest/assets/vendor/libs/apex-charts/apex-charts.css')}}" />
    </x-slot>
    <div class="row">
        <!-- Website Analytics-->
        ...
        <div class="col-md-7 col-lg-7 mb-4 mb-md-0">
            ...
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <img src="{{ asset('template/frest/assets/img/avatars/4.png')}}" alt="Avatar" class="rounded-circle me-3" width="54" />
                <div class="card-title mb-0">
            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-column me-2">
                    ...
                    >
                        <img class="rounded-circle" src="{{ asset('template/frest/assets/img/avatars/5.png')}}" alt="Avatar" />
                    </li>
                    <li
                        data-bs-toggle="tooltip"
                        data-popup="tooltip-custom"
                        ...
                        class="avatar avatar-xs pull-up"
                    >
                        <img class="rounded-circle" src="{{ asset('template/frest/assets/img/avatars/12.png')}}" alt="Avatar" />
                    </li>
                    <li
                        data-bs-toggle="tooltip"
                        data-popup="tooltip-custom"
                        ...
                        class="avatar avatar-xs pull-up"
                    >
                        <img class="rounded-circle" src="{{ asset('template/frest/assets/img/avatars/6.png')}}" alt="Avatar" />
                    </li>
                    <li
                        data-bs-toggle="tooltip"
                        data-popup="tooltip-custom"
                        ...
                        class="avatar avatar-xs pull-up"
                    >
                        <img class="rounded-circle" src="{{ asset('template/frest/assets/img/avatars/14.png')}}" alt="Avatar" />
                    </li>
                    <li
                        data-bs-toggle="tooltip"
                        data-popup="tooltip-custom"
                        ...
                        class="avatar avatar-xs pull-up"
                    >
                        <img class="rounded-circle" src="{{ asset('template/frest/assets/img/avatars/10.png')}}" alt="Avatar" />
                    </li>
                    </ul>
                </div>
                <div class="d-flex flex-column me-2">
            ...
            <div class="card-body">
                ...
                <li class="timeline-item timeline-item-transparent ps-4">
                    ...
                    <div class="d-flex">
                        ...
                        <img
                            src="{{ asset('template/frest/assets/img/icons/misc/pdf.png')}}"
                            alt="PDF image"
                            width="23"
                            class="me-2"
                        />
                ...
                <li class="timeline-item timeline-item-transparent ps-4">
                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        <img src="{{ asset('template/frest/assets/img/avatars/1.png')}}" alt="Avatar" class="rounded-circle" />
                        </div>
                        <div>
                ...
                <li class="timeline-item timeline-item-transparent ps-4">
                    ...
                    <div class="d-flex align-items-center avatar-group">
                        ...
                        title="Vinnie Mostowy"
                        >
                        <img src="{{ asset('template/frest/assets/img/avatars/5.png')}}" alt="Avatar" class="rounded-circle" />
                        </div>
                        <div
                        class="avatar avatar-sm pull-up"
                        data-bs-toggle="tooltip"
                        ...
                        title="Marrie Patty"
                        >
                        <img src="{{ asset('template/frest/assets/img/avatars/12.png')}}" alt="Avatar" class="rounded-circle" />
                        </div>
                        <div
                        class="avatar avatar-sm pull-up"
                        data-bs-toggle="tooltip"
                        ...
                        title="Jimmy Jackson"
                        >
                        <img src="{{ asset('template/frest/assets/img/avatars/9.png')}}" alt="Avatar" class="rounded-circle" />
                        </div>
                        <div
                        class="avatar avatar-sm pull-up"
                        data-bs-toggle="tooltip"
                        ...
                        title="Kristine Gill"
                        >
                        <img src="{{ asset('template/frest/assets/img/avatars/6.png')}}" alt="Avatar" class="rounded-circle" />
                        </div>
                        <div
                        class="avatar avatar-sm pull-up"
                        data-bs-toggle="tooltip"
                        ...
                        title="Nelson Wilson"
                        >
                        <img src="{{ asset('template/frest/assets/img/avatars/14.png')}}" alt="Avatar" class="rounded-circle" />
                        </div>
                    </div>
                    </div>
                </li>
